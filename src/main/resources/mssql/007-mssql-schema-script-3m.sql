...
/****** Object:  Database [apiary_3m]    Script Date: 07/18/2013 17:26:43 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'apiary_3m')
DROP DATABASE [apiary_3m]
GO
