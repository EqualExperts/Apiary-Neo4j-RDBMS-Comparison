...
/****** Object:  Database [apiary_10k]    Script Date: 07/18/2013 17:26:43 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'apiary_10k')
DROP DATABASE [apiary_10k]
GO
