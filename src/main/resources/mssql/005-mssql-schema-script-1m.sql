...
/****** Object:  Database [apiary_1m]    Script Date: 07/18/2013 17:26:43 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'apiary_1m')
DROP DATABASE [apiary_1m]
GO
