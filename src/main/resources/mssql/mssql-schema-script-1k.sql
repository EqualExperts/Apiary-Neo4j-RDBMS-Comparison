...
/****** Object:  Database [apiary_1k]    Script Date: 07/18/2013 17:26:43 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'apiary_1k')
DROP DATABASE [apiary_1k]
GO
