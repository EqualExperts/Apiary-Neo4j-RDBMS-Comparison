...
/****** Object:  Database [apiary_100k]    Script Date: 07/18/2013 17:26:43 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'apiary_100k')
DROP DATABASE [apiary_100k]
GO
