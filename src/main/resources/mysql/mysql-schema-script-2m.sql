DROP SCHEMA `apiary_2m` ;
CREATE SCHEMA `apiary_2m` ;

CREATE  TABLE `apiary_2m`.`person` (
...
CREATE  TABLE `apiary_2m`.`person_direct_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_person_direct_reportee_1`
    ...
    REFERENCES `apiary_2m`.`person` (`id` )
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
...
CREATE  TABLE `apiary_2m`.`person_indirect_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  `person_id` BIGINT NOT NULL ,
