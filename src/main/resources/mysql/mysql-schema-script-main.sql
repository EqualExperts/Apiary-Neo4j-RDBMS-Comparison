#DROP SCHEMA `apiary` ;
CREATE SCHEMA `apiary` ;

CREATE  TABLE `apiary`.`person` (
...
CREATE  TABLE `apiary`.`person_direct_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
...
CREATE  TABLE `apiary`.`person_indirect_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  `person_id` BIGINT NOT NULL ,
