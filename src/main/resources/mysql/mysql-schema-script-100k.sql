#DROP SCHEMA `apiary_100k` ;
CREATE SCHEMA `apiary_100k` ;

CREATE  TABLE `apiary_100k`.`person` (
...
CREATE  TABLE `apiary_100k`.`person_direct_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_person_direct_reportee_1`
    ...
    REFERENCES `apiary_100k`.`person` (`id` )
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
...
CREATE  TABLE `apiary_100k`.`person_indirect_reportee` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  `person_id` BIGINT NOT NULL ,
